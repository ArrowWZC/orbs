package com.neo.sk.orbs.front.orbs

import java.util.concurrent.atomic.AtomicInteger

import com.neo.sk.orbs.front.utils.byteObject.MiddleBufferInJs
import com.neo.sk.orbs.front.utils.{JsFunc, Shortcut}
import com.neo.sk.orbs.shared.ptcl
import com.neo.sk.orbs.shared.ptcl.model.{Boundary, Point}
import com.neo.sk.orbs.shared.ptcl.protocol.ThorGame._
import com.neo.sk.orbs.shared.ptcl.protocol._
import com.neo.sk.orbs.shared.ptcl.orbs.GridState
import mhtml.Var
...
class GameHolder(canvasName:String) {
  ...
  private def wsMessageHandler(e:MessageEvent) = {
    import com.neo.sk.orbs.front.utils.byteObject.ByteObject._
    e.data match {
      case blobMsg:Blob =>
